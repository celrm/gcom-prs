...
"""
plt.contourf(lons, lats, air21[0, 0, :, :], cmap=CMAP, levels=LEV)
plt.savefig("1")
...
for i in range(4):
    ...
    ax.text(0.5, 90, "PCA-" + str(i), fontsize=15, ha="center")
    plt.contourf(lons, lats, Element_pca0[i, :, :], cmap=CMAP, levels=LEV)
plt.savefig("2")
...
ax.text(0.5, 90, "Observación HGT", fontsize=15, ha="center")
plotted = hgt_0[level==500.,:,:]
plt.contourf(lons_sub, lats_sub, plotted[0], cmap=CMAP, levels=LEV)

ax = fig.add_subplot(2, 2, 2)
ax.text(0.5, 90, "HGT-media", fontsize=15, ha="center")
plotted = hgt_1[level==500.,:,:]
plt.contourf(lons_sub, lats_sub, plotted[0], cmap=CMAP, levels=LEV)

ax = fig.add_subplot(2, 2, 3)
ax.text(0.5, 90, "Observación AIR", fontsize=15, ha="center")
plotted = air_0[level==1000.,:,:]
plt.contourf(lons_sub, lats_sub, plotted[0], cmap=CMAP, levels=LEV)

ax = fig.add_subplot(2, 2, 4)
ax.text(0.5, 90, "AIR-media", fontsize=15, ha="center")
